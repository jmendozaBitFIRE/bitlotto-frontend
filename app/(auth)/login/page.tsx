    ...
    <div className="flex min-h-screen items-center justify-center bg-background p-4">
      <Card className="w-full max-w-md border-white/10 bg-surface shadow-2xl">
        <CardContent className="flex flex-col items-center p-8">
          {/* Logo Section */}
          <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-brand/10 ring-8 ring-brand/5">
            <Ticket className="h-8 w-8 text-brand" />
          </div>

          <h1 className="text-3xl font-bold text-white mb-2">Rifas SaaS</h1>
          <p className="text-muted-foreground mb-8 text-sm">Ingresa a tu panel de control</p>

          <form onSubmit={handleSubmit} className="w-full space-y-6">
            <div className="space-y-2">
              <label className="text-sm font-medium text-white px-1">Correo electrónico</label>
              <Input
                type="email"
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-white px-1">Contraseña</label>
              <Input
                type="password"
                placeholder="........"
                value={password}
          ...
          <div className="relative my-8 w-full">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-surface px-2 text-muted-foreground">O continuar con</span>
            </div>
          </div>
          ...
          <div className="mt-12 text-center">
            ...
            <div className="space-y-1">
              <p className="text-[10px] text-muted-foreground">
                Superadmin: <span className="text-white">admin@rifas.com / admin</span>
              </p>
              <p className="text-[10px] text-muted-foreground">
                Organizador: <span className="text-white">juan@rifas.com / juan</span>
              </p>
            </div>
          </div>
        </CardContent>
