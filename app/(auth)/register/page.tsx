      ...
      <Card className="w-full max-w-md border-white/10 bg-surface shadow-2xl">
        <CardContent className="flex flex-col items-center p-8">
          ...
          <p className="text-muted-foreground mb-8 text-sm text-center">
            Únete a Rifas SaaS y comienza a gestionar tus sorteos
          </p>

          <Button
            variant="outline"
            type="button"
            className="w-full h-12 border-white/10 hover:bg-white/5 text-white font-medium flex items-center justify-center"
